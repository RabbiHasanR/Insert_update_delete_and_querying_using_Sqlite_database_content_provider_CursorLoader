...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void savePet() {
        ...
        if (mCurrentPetUri == null &&
                ...
                TextUtils.isEmpty(petWeight) && mGender == PetsEntry.GENDER_UNKNOWN) {
            return;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                showUnsaveChangeDialog(discardButtonClickListener);
                return true;
        }
    ...
    private void showUnsaveChangeDialog(DialogInterface.OnClickListener discardButtonClickListener) {
